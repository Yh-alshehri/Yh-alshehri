...
* 🛠️ My stack: **Python, Linux, Docker, Bash, PyTorch, TensorFlow, and Git**.
* 📜 Certified in **Linux Systems Administration & Network Engineering APIs**.
* 🚀 I build **cloud-native ML deployments, network monitors, and automated Linux systems**.
* 💡 Mindset: *Engineering intelligent cloud solutions with clarity, precision, and care.*
...
* 💡 **Analytical Innovation & Research**
* ⏱️ **Project Planning & Time Management**
